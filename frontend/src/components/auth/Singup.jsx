...
const Singup = () => {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      const res = await axios.post("https://nextstep-rqja.onrender.com/api/v1/user/register", formData, {
        headers: {
        ...
        <form onSubmit={submitHandler} className='w-1/2 border border-gray-200 rounded-md p-4 my-10'>
          ...
          <div className='my-2'>
            ...
            <Input
              ...
              name="email"
              onChange={changeEventHandler}
              placeholder="umar971361@gmail.com"
            />
          </div>
          <div className='my-2'>

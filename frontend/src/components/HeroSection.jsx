    ...
    return (
        <div className='text-center'>
            <div className='flex flex-col gap-5 my-10'>
                ...
                <div>
                    <p className='text-gray-500'>Your next career move starts here - discover jobs that match your skills and ambitions.<br /> We connect talented professionals with their ideal workplaces.</p>
                </div>
